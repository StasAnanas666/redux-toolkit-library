                    ...
                    {books.map(book => (
                        <li key={book.key} className="list-group-item">
                            <div>
                                ...
                                <button className="btn btn-outline-warning" onClick={() =>handleEdit(book)}>Edit</button>
                                <button className="btn btn-outline-danger" onClick={() =>handleDelete(book.key)}>Delete</button>
                            </div>
                        </li>
                    ))}
                </ul>
